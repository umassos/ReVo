"""
Depth packet loss recovery inference script.
...
Usage:
  ...
  python depth/test_depth_stage2.py \\
      --checkpoint  ../../.checkpoints/h265/h265_depth.pth \\
...
def get_args():
    parser = argparse.ArgumentParser(
        description="Evaluate VideoMAE-based model for depth packet loss recovery")
    ...
    parser.add_argument("--clean_path",     type=str, required=True,
                        help="Directory of ground-truth (clean) depth videos")
    parser.add_argument("--corrupted_path", type=str, required=True,
                        help="Directory of codec-corrupted depth videos")
